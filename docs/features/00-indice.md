...
## Dominio 1 — Personas y reunificación
| # | Feature | Resumen | Prioridad |
|---|---------|---------|-----------|
| [01](01-reunificacion-familiar.md) | **Reunificación familiar / personas desaparecidas** | Solicitud privada de búsqueda de personas (persona + última ubicación + contacto), revisada por coordinación; no pública | 🔴 Alta |
...
## Dominio 2 — Campo y rescate (SAR)
| # | Feature | Resumen | Prioridad |
|---|---------|---------|-----------|
| [03](03-danos-estructurales-personas-atrapadas.md) | **Daños estructurales y personas atrapadas** | Reportes de edificaciones (colapsada/dañada/atrapados) revisados antes de publicar | 🟡 Media |

## Dominio 3 — Vertical sanitario
| # | Feature | Resumen | Prioridad |
|---|---------|---------|-----------|
...
## Dominio 4 — Núcleo de necesidades y ofertas
| # | Feature | Resumen | Prioridad |
|---|---------|---------|-----------|
...
## Dominio 5 — Mapa y geolocalización
| # | Feature | Resumen | Prioridad |
|---|---------|---------|-----------|
...
**Orden sugerido de abordaje:** 04 (plantilla sanitaria) y 06 (caducidad) son rápidos y de alto valor; 01 (reunificación) y 03 (SAR) son los huecos grandes de "primeras horas"; 09 (privacidad de ubicación) es transversal y debería entrar pronto.
