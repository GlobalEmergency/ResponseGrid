 ...
 * finer, safer grain than per-IP); everything else keys by the real client IP
 * (CF-Connecting-IP behind Cloudflare, see {@link clientIp}). Extracted as a
 * pure function so it can be unit-tested without the throttler runtime (#315).
 */
