...
export const es = {
  ...
  supplyLine: {
    ...
    presentationLabel: 'Presentación / vía',
    presentationOpt: '(opcional)',
    presentationPlaceholder: 'ej. ampolla, EV, inhalador',
    presentationOptions: [
      'Ampolla',
      'EV (intravenoso)',
      'Inhalador',
  ...
  admin: {
    ...
    // ── Usuarios (admin global) — issue #176 ──────────────────────────────
    users_meta_title: 'Usuarios — Admin · ResponseGrid',
    users_meta_description:
      'Listado global de usuarios. Solo administradores.',
    users_back: '← Administración',
    users_title: 'Usuarios',
    users_subtitle:
      'Listado global de todas las cuentas. Solo administradores (datos personales).',
    users_list_heading: 'Usuarios ({count})',
    users_search_label: 'Buscar usuario',
    users_search_ph: 'Buscar por nombre o email…',
    users_empty_title: 'No hay usuarios registrados.',
    users_empty_description: 'Cuando alguien se registre aparecerá aquí.',
    users_no_results_title: 'Sin resultados.',
    users_no_results_description: 'Ningún usuario coincide con la búsqueda.',
    users_email_label: 'Email:',
    users_created_label: 'Alta:',
    users_last_login_label: 'Último acceso:',
    users_never: 'Nunca',
    users_roles_label: 'Roles:',
    users_no_roles: 'Sin roles',
    users_admin_badge: 'Administrador',
    // Tipos de ámbito de un grant
    users_scope_platform: 'Plataforma',
    users_scope_organization: 'Organización',
    users_scope_emergency: 'Emergencia',
    users_scope_group: 'Grupo',
    users_scope_entity: 'Entidad',
    users_scope_hub: 'Hub',
    users_scope_corridor: 'Corredor',
    // Ficha de detalle
    users_detail_meta_title: 'Usuario — Admin · ResponseGrid',
    users_detail_back: '← Usuarios',
    users_detail_not_found: 'Usuario no encontrado.',
    users_detail_grants_heading: 'Roles y permisos ({count})',
    users_detail_grants_empty: 'Este usuario no tiene roles asignados.',
    users_grant_scope_label: 'Ámbito:',
    users_grant_granted_label: 'Concedido:',
    users_grant_expires_label: 'Caduca:',
    users_grant_expired: 'Caducado',
    users_detail_orgs_heading: 'Organizaciones ({count})',
    users_detail_orgs_empty: 'No pertenece a ninguna organización.',
    ...
    centros_detail_inv_cta: 'Registrar entrada',
    centros_detail_inv_title: 'Registrar entrada de inventario',
    centros_detail_inv_intro:
      'Añade material que ha llegado al centro. Se sumará al inventario declarado (las líneas iguales se acumulan, no se duplican).',
    centros_detail_inv_items_legend: 'Material recibido',
    centros_detail_inv_name_label: 'Nombre del material',
    centros_detail_inv_name_ph: 'p. ej. Agua embotellada 1,5 L',
    centros_detail_inv_qty_label: 'Cantidad',
    centros_detail_inv_qty_ph: 'Cantidad',
    centros_detail_inv_unit_label: 'Unidad',
    centros_detail_inv_unit_ph: 'p. ej. botellas',
    centros_detail_inv_category_label: 'Categoría',
    centros_detail_inv_remove: 'Quitar línea',
    centros_detail_inv_add: '+ Añadir otra línea',
    centros_detail_inv_submit: 'Registrar entrada',
    centros_detail_inv_submitting: 'Registrando…',
    centros_detail_inv_err_items: 'Añade al menos una línea de material válida.',
    centros_detail_inv_err_qty: 'La cantidad debe ser un número entero ≥ 1.',
    centros_detail_inv_err_forbidden:
      'No tienes permiso para registrar inventario en este centro.',
    centros_detail_inv_err_not_found: 'El centro ya no existe.',
    centros_detail_inv_err_failed:
  ...
  ui: {
    ...
    org_create_button: 'Crear organización',
    org_modal_title: 'Nueva organización',
    org_modal_submit: 'Crear y seleccionar',
    org_modal_cancel: 'Cancelar',
    modal_close: 'Cerrar',
  ...
  panel: {
    ...
    home_section_resources: 'Tus recursos',
    home_section_orgs_groups: 'Tus organizaciones y cuadrillas',
    home_register_resource: 'Registrar un recurso',
    role_generic_resource: 'Gestora',
