...
export const en = {
  ...
  admin: {
    ...
    // ── Users (global admin) — issue #176 ─────────────────────────────────
    users_meta_title: 'Users — Admin · ResponseGrid',
    users_meta_description: 'Global users directory. Administrators only.',
    users_back: '← Administration',
    users_title: 'Users',
    users_subtitle:
      'Global directory of every account. Administrators only (personal data).',
    users_list_heading: 'Users ({count})',
    users_search_label: 'Search user',
    users_search_ph: 'Search by name or email…',
    users_empty_title: 'No users registered.',
    users_empty_description: 'Anyone who signs up will appear here.',
    users_no_results_title: 'No results.',
    users_no_results_description: 'No user matches your search.',
    users_email_label: 'Email:',
    users_created_label: 'Joined:',
    users_last_login_label: 'Last login:',
    users_never: 'Never',
    users_roles_label: 'Roles:',
    users_no_roles: 'No roles',
    users_admin_badge: 'Administrator',
    // Grant scope types
    users_scope_platform: 'Platform',
    users_scope_organization: 'Organization',
    users_scope_emergency: 'Emergency',
    users_scope_group: 'Group',
    users_scope_entity: 'Entity',
    users_scope_hub: 'Hub',
    users_scope_corridor: 'Corridor',
    // Detail view
    users_detail_meta_title: 'User — Admin · ResponseGrid',
    users_detail_back: '← Users',
    users_detail_not_found: 'User not found.',
    users_detail_grants_heading: 'Roles and permissions ({count})',
    users_detail_grants_empty: 'This user has no roles assigned.',
    users_grant_scope_label: 'Scope:',
    users_grant_granted_label: 'Granted:',
    users_grant_expires_label: 'Expires:',
    users_grant_expired: 'Expired',
    users_detail_orgs_heading: 'Organizations ({count})',
    users_detail_orgs_empty: 'Not a member of any organization.',
    ...
    centros_detail_inv_cta: 'Record entry',
    centros_detail_inv_title: 'Record inventory entry',
    centros_detail_inv_intro:
      'Add material that has arrived at the center. It is summed into the declared inventory (identical lines accumulate, they are not duplicated).',
    centros_detail_inv_items_legend: 'Received material',
    centros_detail_inv_name_label: 'Material name',
    centros_detail_inv_name_ph: 'e.g. Bottled water 1.5 L',
    centros_detail_inv_qty_label: 'Quantity',
    centros_detail_inv_qty_ph: 'Quantity',
    centros_detail_inv_unit_label: 'Unit',
    centros_detail_inv_unit_ph: 'e.g. bottles',
    centros_detail_inv_category_label: 'Category',
    centros_detail_inv_remove: 'Remove line',
    centros_detail_inv_add: '+ Add another line',
    centros_detail_inv_submit: 'Record entry',
    centros_detail_inv_submitting: 'Recording…',
    centros_detail_inv_err_items: 'Add at least one valid material line.',
    centros_detail_inv_err_qty: 'Quantity must be a whole number ≥ 1.',
    centros_detail_inv_err_forbidden:
      "You don't have permission to record inventory at this center.",
    centros_detail_inv_err_not_found: 'The center no longer exists.',
  ...
  ui: {
    ...
    org_create_button: 'Create organization',
    org_modal_title: 'New organization',
    org_modal_submit: 'Create and select',
    org_modal_cancel: 'Cancel',
    modal_close: 'Close',
